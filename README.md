...
### Example Configuration (`config.json` snippet)
  ...
  "printers": [
    {
      ...
      "octoprint_apikey": "YOUR_OCTOPRINT_API_KEY",
      "console_channel_id": "YOUR_CONSOLE_TELEGRAM_CHANNEL_ID",
      "printer_status_channel_id": "YOUR_STATUS_TELEGRAM_CHANNEL_ID"
    }
  ],
  "octoeverywhere": {
    "enabled": true,
    "user_id": "YOUR_OCTO_USER_ID",
    "api_key": "YOUR_OCTO_API_KEY"
  },
  "telegram_bot_token": "YOUR_TELEGRAM_BOT_TOKEN"
}
```
*Remember to replace placeholder values with your actual credentials and IDs.*
